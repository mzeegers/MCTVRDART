...
for NL in ParamsNoiseLevel:
    ...
    AvgErrorJointTotal = 0
    AvgErrorSepTotal = 0

    it = 0
    for Atts in FixedAttenuationsAll:
        ################################
        ##### Make projection data #####
        ################################

        print("NL " + str(NL), ", it ", str(it))
        it += 1
        ...
        NiterParam = ParamsNiterParamJoint
        NiterRecon = ParamsNiterReconJoint
        ...
        NiterParam = ParamsNiterParamSep
        NiterRecon = ParamsNiterReconSep
