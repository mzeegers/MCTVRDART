...
# Joint estimation of reconstruction and parameters
def jointMC(W,p,x0, param0 ,lamb=1, Niter = 20, sf = 1):
    ...
    input()
    for iter in range(Niter):
        print(str(param2gv(param_esti*sf)))
        gvpre,Kpre = param2gv(param_esti)
        print(gvpre,Kpre)
...
def reconMC(W,p,x0 ,param,lamb=1, Niter = 2, epsilon=1e-4):
    siz = x0.shape[1:]
